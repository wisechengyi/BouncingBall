...
%     i(max(1,-x+xc),  min(c,y+yc)) = value;
    ...
    i( max(1,-x+xc):min(x+xc,r),  min(c,y+yc)) = value;
    i( max(1,-y+xc):min(y+xc,r),  min(c,x+yc)) = value;
    i( max(1,-y+xc):min(y+xc,r), max(1,-x+yc)) = value;
    i( max(1,-x+xc):min(x+xc,r), max(1,-y+yc)) = value;
